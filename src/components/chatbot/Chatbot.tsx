  ...
  return (
    <>
      { !isOpen && showHelpBubble && (
        <div className="fixed bottom-10 right-4 z-40 animate-in fade-in-50 slide-in-from-bottom-4 md:bottom-24 md:right-6">
      ...
      <Button
          ...
          className={cn(
            "fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 h-12 w-12 rounded-full flex items-center justify-center p-0 shrink-0",
            "sm:h-14 sm:w-14 [&_svg]:h-6 [&_svg]:w-6 sm:[&_svg]:h-7 sm:[&_svg]:w-7",
