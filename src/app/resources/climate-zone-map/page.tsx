            ...
            <div className="max-w-4xl mx-auto">
                <article className="prose dark:prose-invert max-w-none">
                    ...
                    <p className="text-lg text-muted-foreground">
                        The U.S. Department of Energy has divided the country into eight climate zones. These zones are crucial for building and construction, as they help determine the appropriate heating, ventilation, and air conditioning (HVAC) system size, as well as the recommended level of insulation for a home.
                    </p>
                    
                    <div className="my-12">
                        <Image 
                            src="https://placehold.co/1200x750.png"
                            alt="U.S. Climate Zone Map"
                            width={1200}
                            height={750}
                            className="rounded-lg shadow-lg border w-full"
                            data-ai-hint="US climate map"
                        />
                         <p className="text-center text-sm text-muted-foreground mt-2">Find your state on the map to identify your climate zone number.</p>
                    </div>
