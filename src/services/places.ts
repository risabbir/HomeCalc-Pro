    ...
    return [
      {
        ...
        vicinity: '321 Canvas Rd, Anytown',
      },
      {
        name: 'Fresh Coat Painters',
        rating: 4.7,
        user_ratings_total: 189,
        vicinity: '654 Brush Blvd, Anytown',
      },
    ];
  } else if (query.toLowerCase().includes('electrician')) {
    return [
      {
        name: 'Sparky & Sons Electric',
        rating: 4.8,
        user_ratings_total: 450,
        vicinity: '111 Volt Ct, Anytown',
      },
      {
        name: "Watt's Up Electricians",
        rating: 4.5,
        user_ratings_total: 123,
        vicinity: '222 Amp Way, Anytown',
      },
    ];
  }
